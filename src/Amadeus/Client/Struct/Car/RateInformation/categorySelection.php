...
class categorySelection
{
     ...
     * @param Category
     */
    public function __construct(Category $details)
    {

        $this->selectionDetails = new selectionDetails($details->selectionDetails->option);
        $this->otherSelectionDetails = new otherSelectionDetails($details->otherSelectionDetails->option);
