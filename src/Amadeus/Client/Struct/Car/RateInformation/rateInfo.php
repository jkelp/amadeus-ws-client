...
class rateInfo
{
     ...
     * @param RateInform
     */
    public function __construct(RateInform $details)
    {

        $this->tariffInfo = new tariffInfo($details->ratePlanIndicator, $details->rateType);
        $this->rateInformation = new rateInformation($details->category);
