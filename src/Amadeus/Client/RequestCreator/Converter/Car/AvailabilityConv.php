 ...
 */
class AvailabilityConv extends BaseConverter
{
    /**
     * @param CarAvailOptions $requestOptions
     * @param int|string $version
     * @return Struct\Car\Availabilty\Car_Availability
     */
    public function convert($requestOptions, $version)
    {
        return new Struct\Car\Availability\Car_Availability($requestOptions);
    }
}
