 ...
 */
class ModifyConv extends BaseConverter
{
    /**
     * @param CarModifyOptions $requestOptions
     * @param int|string $version
     * @return Struct\Car\Car_Modify
     */
    public function convert($requestOptions, $version)
    {
        return new Struct\Car\Car_Modify($requestOptions);
    }
}
