 ...
 */
class LocationListConv extends BaseConverter
{
    /**
     * @param CarLocationListOptions $requestOptions
     * @param int|string $version
     * @return Struct\Car\LocationList\Car_LocationList
     */
    public function convert($requestOptions, $version)
    {
        return new Struct\Car\Car_LocationList($requestOptions);
    }
}
